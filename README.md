...
So I did it via Lisp, ;-) because why not make it weird? [Allegro CL](https://franz.com/products/allegro-common-lisp/) provided [Allegro Prolog](https://franz.com/support/documentation/current/doc/prolog.html), which was a way for me to get to use "two birds with one stone," as it were.
